...
void setup() {
 ...
 digitalWrite(13, LOW);
    ...
    //send to USART         
    Serial.println("This lab demonstrates serial control of the Arduino.");
    Serial.println("It also changes motor operating states based on feedback from tachometer.");
    Serial.println("Type \"start\" to initiate a motor start sequence.");                    // echo string on serial port
...
//    Serial.println(val);
    ...
    Serial.println("Full power at your command. Type \"engage\" to initiate.");
    lcd.clear();
    ...
    serial_gets(buf2, 32);                   //
    Serial.println(buf2);                    // echo string on serial port
    
    
   if( strcmp(buf2, "engage") == 0) {
      //A2.8 t=9secs
      Serial.println("By your command - Full power engaged");
      lcd.clear();
      ...
      Serial.println("Relay K1 duty cycle reduced to save power.");
      lcd.clear();
      lcd.print("PWM K1");
      delay(5000);
